  ...
  return (
    <>
      ...
      <main className="font-firacode mx-[25px] mt-[50px] text-[#E4E4E7]">
        ...
        <p className="text-[16px] text-[400] md:text-[30px] md:text-[700]">I'm a Full Stack Developer</p>
        ...
        <div className="social-links flex justify-between md:justify-start md:gap-[10px] mt-[15px] md:mt-[30px]">
          <a href={resume} target="_blank" rel="noopener noreferrer" className="md:text-[23px]" download>
            <span className="slash">//</span>Resume
          </a>
          <a href={portfolio_data.user_details.linkedin} target="_blank" className="md:text-[23px]" rel="noopener noreferrer" >
            <span className="slash">//</span>LinkedIn
          </a>
          <a href={portfolio_data.user_details.X} target="_blank" className="md:text-[23px]" rel="noopener noreferrer">
            <span className="slash">//</span>X
          </a>
          <a href={portfolio_data.user_details.email} target="_blank" className="md:text-[23px]" rel="noopener noreferrer">
            <span className="slash">//</span>Email
          </a>
          <a href={portfolio_data.user_details.github} target="_blank" className="md:text-[23px]" rel="noopener noreferrer">
            <span className="slash">//</span>Github
          </a>
        </div>
        {/* Skills */}
        <div className="skills mt-[50px] md:mt-[70px]">
          <h2 className="text-[#00E5FF] text-[16px] mb-[20px] md:text-[30px]">//Skills</h2>
          <Skills
        ...
        <div>
          <div className="flex items-center mt-[50px] mb-[20px]">
            <h2 className="text-[#00E5FF] text-[16px] md:text-[30px]">//Projects</h2>
